...
var ShowserviceService = /** @class */ (function () {
    function ShowserviceService(httpClient) {
        this.httpClient = httpClient;
    }
    ShowserviceService.prototype.getEmployees = function () {
        return [
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.getv = function () {
        alert("hi");
    };
...
var User2componentComponent = /** @class */ (function () {
    function User2componentComponent(userservice, router) {
        this.userservice = userservice;
        this.router = router;
        this.collars = [1, 2];
    ...
    User2componentComponent.prototype.myClickcollar = function (getv) {
        this.collarvars = getv;
        this.userservice.secondcollar = getv;
        // alert(getv);
        // this.router.navigate(["/secondpage"]);
    };
    User2componentComponent.prototype.ngOnInit = function () { };
    User2componentComponent.prototype.clicklogin = function (event) {
    ...
    return User2componentComponent;
}());
...
var UsercomponentComponent = /** @class */ (function () {
    function UsercomponentComponent(router, userservice) {
        this.router = router;
        this.userservice = userservice;
        this.count = [
            [1, 2, 3, 4, 5, 6],
    ...
    UsercomponentComponent.prototype.myClickFunction = function (getv) {
        this.newvars = getv;
        this.userservice.firstvar = getv;
        this.router.navigate(["/secondpage"]);
    };
    UsercomponentComponent.prototype.nextmove = function () {
        this.router.navigate(["/secondpage"]);
    };
